...
class WorkmatesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val searchView: androidx.appcompat.widget.SearchView = layoutInflater.findViewById(R.id.workmates_fragment_search_icon)
                searchView.setOnQueryTextFocusChangeListener { _ , hasFocus ->
            if (hasFocus) {
                // searchView expanded
                workmates_fragment_title.visibility = View.GONE
            } else {
                // searchView not expanded
                workmates_fragment_title.visibility = View.VISIBLE
            }
        }
